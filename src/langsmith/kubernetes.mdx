...
For [agent deployment](/langsmith/deployment): To add deployment capabilities, complete this guide first, then follow [Enable LangSmith Deployment, Fleet, Insights, and Assistant](/langsmith/deploy-self-hosted-full-platform).
...
## Enable LangSmith Deployment, Fleet, Insights, and Assistant
...
- **[Assistant](/langsmith/assistant)**: an AI assistant embedded across LangSmith to help you analyze traces, threads, prompts, and experiment results.

Follow the [Enable LangSmith Deployment, Fleet, Insights, and Assistant](/langsmith/deploy-self-hosted-full-platform) guide to set up these components.
