...
Use the **[Assistant](/langsmith/assistant)** AI assistant in the Playground to generate tools, create output schemas, and optimize your prompts with AI assistance.
</Callout>
