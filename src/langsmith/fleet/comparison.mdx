...
| **Self-hosting** | ✅ [Beta](/langsmith/deploy-self-hosted-full-platform#enable-fleet-insights-and-assistant), [contact sales](https://www.langchain.com/contact-sales) for production readiness details | ❌ | ❌ | ❌ | ❌ |
...
| ------- | --------- | ----------------- | ---------------- | --------------------------- | --------------------- |
| Cloud-hosted | ✅ | ⚠️ | ✅ | ✅ | ✅ |
| Self-hosted | ✅ [Beta](/langsmith/deploy-self-hosted-full-platform#enable-fleet-insights-and-assistant), [contact sales](https://www.langchain.com/contact-sales) for production readiness details | ❌ | ❌ | ❌ | ❌ |
