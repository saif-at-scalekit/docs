---
title: Enable LangSmith Deployment, Fleet, Insights, and Assistant
sidebarTitle: Enable additional features
description: Enable LangSmith Deployment, Fleet, Insights, and Assistant on a self-hosted LangSmith instance.
---
...
- **[Assistant](/langsmith/assistant)** provides an AI assistant embedded in your LangSmith workspace to help you analyze traces, threads, prompts, and experiment results.
...
## Enable Fleet, Insights, and Assistant
...
Enabling these features provisions the following components in your cluster for each feature (Fleet, Insights, Assistant):
...
<Steps>
  <Step title="Add the configuration to your langsmith_config.yaml">
    <Tabs>
      ...
      <Tab title="Using inline values">
        ...
        polly:
          enabled: true
          encryptionKey: "<assistant-encryption-key>"
  ...
  <Step title="Apply the changes">
    ...
    Verify the Fleet, Insights, and Assistant pods are running:
...
To disable any combination of Fleet, Insights, and Assistant, set the corresponding flags to `false` in your [`langsmith_config.yaml`](/langsmith/kubernetes#configure-your-helm-charts):
